...
public class Day14Tests
{
    ...
    {
        Day14.Solve1(input).Should().Be(expected);
    }

    [Test]
    public void Part1_ReturnsCorrectAnswer()
    {
        Day14.Part1().Should().Be(857266);
    }
    ...
    {
        Day14.Solve2(input).Should().Be(expected);
    }

    [Test]
    public void Part2_ReturnsCorrectAnswer()
    {
        Day14.Part2().Should().Be(2144702);
    }
}
